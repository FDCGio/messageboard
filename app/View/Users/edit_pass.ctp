...
<div class="row">
    ...
    <div class="col-md-8"><br>
        ...
        <div class="card mt-2">
            ...
            <div class="card-body">
                <form action="/messageboard/users/update_password" method="post">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control" id="password" autocomplete="off" name="data[User][password]">
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">Confirm Password</span>
                                    <input type="password" class="form-control" id="c_pass" autocomplete="off">
                                </div>
                                <div class="input-group mb-3">
...
<?php echo $this->Html->script('/js/users/edit_pass.js');?>
